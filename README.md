...
>>> usage: train.py [-h] [--wandb_api_key WANDB_API_KEY] [-v VERBOSITY] [--input_dims H W] [--epochs NUM_EPOCHS] [--batch_size N] [--loss_fn LOSS_FUNCTION] [--learning_rate LR]
                [--exp_track TRACK_EXPERIMENT] [--in_channels IN_C] [--out_channels OUT_C] [--filters FILTERS]
...
Hyperparameters for model training:
  ...
  --loss_fn LOSS_FUNCTION
                        Loss function for model training (default: BCEWithLogitsLoss)
...
Architecture parameters:
  ...
  --filters FILTERS     number of filters desired in the architecture (default: 40)
...
```ShellSession
$ python3 train.py --verbose 0 --input_dims 256 256 --epochs 30 --batch_size 2 --loss_fn BCEWithLogitsLoss --learning_rate 1e-5 --exp_track false --in_channels 1 --out_channels 1 --filters 40 ./data ./models sample_run MURA
```
