...
parser = argparse.ArgumentParser(description='Script to segment an image using a trained checkpoint of PDRU-Net.',
...
parser.add_argument('--filters', type=int, metavar='F',
